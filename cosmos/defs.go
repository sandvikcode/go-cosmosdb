...
type Client interface {
	...
	CreateDocument(ctx context.Context, dbName, colName string, id *string, doc interface{}, ops cosmosapi.CreateDocumentOptions) (*cosmosapi.Resource, cosmosapi.DocumentResponse, error)
